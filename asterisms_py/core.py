...
# %% auto 0
__all__ = ['torch_lib_path', 'NAKED_EYE', 'BINOCULAR', 'TELESCOPIC', 'SCORE_CUTOFFS', 'resultdf', 'schema', 'SearchConfig',
           'ScoreItem', 'Points', 'convert_to_cartesian', 'calculate_distances', 'distance_from_magnitude',
           'distance_from_magnitude_tensor', 'tetrahedron_score', 'square_score', 'measure_squareness_old',
           'measure_squareness', 'radecmag_to_cartesian', 'radecmag_to_angular', 'mass_score_triangle_torch',
           'mass_score_square_torch', 'transform_radecmag_from_numpy', 'global_normalize_tensor',
           'radec_normalize_tensor', 'mag_score', 'score_triangle', 'triangle_extent_deg', 'triangle_extent_deg_batch',
           'shape_extent_deg_batch', 'compute_tilt_batch', 'chain_extent_deg', 'score_collinear_region',
           'process_collinear_regions', 'stars_for_point_and_radius', 'stars_for_center_and_radius', 'get_grid_points',
           'get_grid_point_by_idx', 'get_region', 'get_center', 'ra_to_hms', 'load_catalog_to_gpu', 'reset_gpu_catalog',
           'filter_stars_on_gpu', 'vectorized_filter_batch', 'process', 'add_to_result_and_save', 'process_all_regions']
